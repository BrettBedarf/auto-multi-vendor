...
export type PaymentInput = {
	 ...
	 * as the "metadata" argument. For store, it could contain an ID for the payment and other
...
export type GetStoresQuery = { __typename?: 'Query' } & {
	stores: { __typename?: 'StoreList' } & Pick<StoreList, 'totalItems'> & {
			items: Array<{ __typename?: 'Store' } & Pick<Store, 'name'>>;
		};
};
...
export type GetStoreQuery = { __typename?: 'Query' } & {
	store?: Maybe<{ __typename?: 'Store' } & Pick<Store, 'name'>>;
};
