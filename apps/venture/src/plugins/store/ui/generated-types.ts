...
export type QueryStoresArgs = {
	options?: Maybe<StoreListOptions>;
};
...
export type Order = Node & {
	 ...
	 * ProductVariants nor discounts resulting from applied Promotions. For store,
...
export type StoreList = PaginatedList & {
...
export type StoreListOptions = {
	skip?: Maybe<Scalars['Int']>;
	take?: Maybe<Scalars['Int']>;
	sort?: Maybe<StoreSortParameter>;
	filter?: Maybe<StoreFilterParameter>;
};
...
export type StoreFilterParameter = {
	createdAt?: Maybe<DateOperators>;
	updatedAt?: Maybe<DateOperators>;
	name?: Maybe<StringOperators>;
};

export type StoreSortParameter = {
	id?: Maybe<SortOrder>;
	createdAt?: Maybe<SortOrder>;
	updatedAt?: Maybe<SortOrder>;
	name?: Maybe<SortOrder>;
...
export namespace CreateStore {
	export type Variables = CreateStoreMutationVariables;
	export type Mutation = CreateStoreMutation;
	export type CreateStore = NonNullable<CreateStoreMutation['createStore']>;
}

export namespace UpdateStore {
	export type Variables = UpdateStoreMutationVariables;
	export type Mutation = UpdateStoreMutation;
	export type UpdateStore = NonNullable<UpdateStoreMutation['updateStore']>;
}

export namespace GetStores {
	export type Variables = GetStoresQueryVariables;
	export type Query = GetStoresQuery;
	export type Stores = NonNullable<GetStoresQuery['stores']>;
	export type Items = NonNullable<
		NonNullable<NonNullable<GetStoresQuery['stores']>['items']>[number]
	>;
}

export namespace GetStore {
	export type Variables = GetStoreQueryVariables;
	export type Query = GetStoreQuery;
	export type Store = NonNullable<GetStoreQuery['store']>;
}
...
export type CreateStoreMutation = { __typename?: 'Mutation' } & {
	createStore: { __typename?: 'Store' } & Pick<Store, 'id' | 'name'>;
};
...
export type UpdateStoreMutation = { __typename?: 'Mutation' } & {
	updateStore: { __typename?: 'Store' } & Pick<Store, 'id' | 'name'>;
};
...
export type GetStoresQuery = { __typename?: 'Query' } & {
	stores: { __typename?: 'StoreList' } & Pick<StoreList, 'totalItems'> & {
			items: Array<
...
export type GetStoreQuery = { __typename?: 'Query' } & {
	store?: Maybe<
		{ __typename?: 'Store' } & Pick<Store, 'id' | 'name' | 'createdAt'>
	>;
};
